...
- Summary, recommendation, and board describe one current application collection.
- At most one next action is recommended; it exists and is non-empty.
- The explanation uses the same stage and deadline signals as the ranking.
